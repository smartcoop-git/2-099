...
from dalle_pytorch.tokenizer import tokenizer, HugTokenizer, KoreanTokenizer, YttmTokenizer
...
parser.add_argument('--korean', dest='korean', action='store_true')
...
model_group.add_argument('--text_seq_len', default = 512, type = int, help = 'Text sequence length')
