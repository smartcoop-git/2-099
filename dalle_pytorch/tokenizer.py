...
from transformers import BertTokenizer , AutoTokenizer, AutoModelForMaskedLM, BertModel, BertTokenizerFast, AutoModel
...
class KoreanTokenizer:
    ...
    def tokenize(self, texts, context_length = 512, truncate_text = False):
        if isinstance(texts, str):
            texts = [texts]
